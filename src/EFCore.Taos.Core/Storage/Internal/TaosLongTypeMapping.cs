...
{
    internal class TaosLongTypeMapping : LongTypeMapping
    {
        public TaosLongTypeMapping(string storeType, DbType? dbType = System.Data.DbType.Int64) : base(storeType, dbType)
        {
        }
