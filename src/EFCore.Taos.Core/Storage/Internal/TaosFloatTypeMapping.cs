...
{
    internal class TaosFloatTypeMapping : FloatTypeMapping
    {
        public TaosFloatTypeMapping(string storeType, DbType? dbType = System.Data.DbType.Single) : base(storeType, dbType)
        {
        }
