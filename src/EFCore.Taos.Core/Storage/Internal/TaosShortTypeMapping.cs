...
{
    internal class TaosShortTypeMapping : ShortTypeMapping
    {
        public TaosShortTypeMapping(string storeType, DbType? dbType = System.Data.DbType.Int16) : base(storeType, dbType)
        {
        }
