...
{
    internal class TaosSByteTypeMapping : SByteTypeMapping
    {
        public TaosSByteTypeMapping(string storeType, DbType? dbType = System.Data.DbType.SByte) : base(storeType, dbType)
        {
        }
