...
{
    internal class TaosBoolTypeMapping : BoolTypeMapping
    {
        public TaosBoolTypeMapping(string storeType, DbType? dbType = System.Data.DbType.Boolean) : base(storeType, dbType)
        {
        }
