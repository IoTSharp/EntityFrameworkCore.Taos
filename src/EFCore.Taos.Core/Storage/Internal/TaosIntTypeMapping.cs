...
{
    internal class TaosIntTypeMapping : IntTypeMapping
    {
        public TaosIntTypeMapping(string storeType, DbType? dbType = System.Data.DbType.Int32) : base(storeType, dbType)
        {
        }
