...
{
    internal class TaosDoubleTypeMapping : DoubleTypeMapping
    {
        public TaosDoubleTypeMapping(string storeType, DbType? dbType = System.Data.DbType.Double) : base(storeType, dbType)
        {
        }
