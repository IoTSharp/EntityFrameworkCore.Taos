...
{
    internal class TaosTimeSpanTypeMapping : TimeSpanTypeMapping
    {
        public TaosTimeSpanTypeMapping(string storeType, DbType? dbType = System.Data.DbType.Time) : base(storeType, dbType)
        {
        }
