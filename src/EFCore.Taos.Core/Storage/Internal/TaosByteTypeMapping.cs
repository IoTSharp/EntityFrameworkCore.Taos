...
{
    internal class TaosByteTypeMapping : ByteTypeMapping
    {
        public TaosByteTypeMapping(string storeType, DbType? dbType = System.Data.DbType.Byte) : base(storeType, dbType)
        {
        }
